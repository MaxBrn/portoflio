      ...
      <div className="md:w-3/4 mx-auto pb-30 text-center">
        ...
        <div className="border border-border rounded-3xl p-6 bg-bgColor2 shadow-lg shadow-button mb-10">
          ...
          <p className="text-left leading-relaxed md:leading-loose">
            La liste ne contient pas tous les jeux que j'ai fait dans ma vie, elle me prendrait bien trop de temps à faire et j'en oublierais certains, elle contient surtout les jeux qui m'ont réellement marqué et ont forgé mes goûts en matière de jeux vidéo.
          </p>
          <br/>
          <p className="text-left leading-relaxed md:leading-loose">
            Que ce soit des jeux de mon enfance, des jeux qui ont fait vibrer l'adulte que je suis devenu, des jeux sur lesquels j'ai passé des centaines d'heures, vous trouverez dans cette liste ces jeux qui ont fait le fan de jeu vidéo que je suis aujourd'hui.
          </p>
        </div>
                ...
                <div className="flex flex-col gap-8 items-center text-center">
                  <div className="md:w-1/2 flex flex-row items-center gap-10">
                    ...
                    <div>
                      ...
                      <p className="text-xl mb-4">par {selectedGame.studios?.name}</p>
                    </div>
                  </div>
