...
const GamesWindow = () => {
  ...
  // Récupère la liste des jeux depuis Supabase
      ...
      <div className="bg-bgColor pb-20 flex md:pt-10">
        <div className="text-center border border-border rounded-3xl p-6 bg-bgColor2 shadow-lg shadow-button w-auto mx-auto">
          <div role="status">
            <svg 
              aria-hidden="true" 
              className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-orange-700" 
              viewBox="0 0 100 101" 
              fill="none" 
      ...
      <div className="md:w-3/4 mx-auto pb-30 text-center">
        ...
        <div className="border border-border rounded-3xl p-6 bg-bgColor2 shadow-lg shadow-button mb-10">
          ...
          <p className="text-left leading-relaxed md:leading-loose">
            La liste ne contient pas tous les jeux que j'ai fait dans ma vie,
            elle me prendrait bien trop de temps à faire et j'en oublierais certains, elle contient surtout les jeux
            qui m'ont réellement marqué et ont forgé mes goûts en matière de jeux vidéo.
          </p>
          <br/>
          <p className="text-left leading-relaxed md:leading-loose">
            Que ce soit des jeux de mon enfance, des jeux qui ont fait vibrer l'adulte que je suis devenu, 
