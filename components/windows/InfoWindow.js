...
const InfoWindow = () => {
  return (
    <div className="bg-bgColor">
      <div className="w-2/3 mx-auto pb-20 text-center">
        ...
        <p>Je suis un étudiant développeur en L3 MIAGE qui veut devenir enseignant
        ...
        <p>J'ai réalisé ce portfolio avec l'idée d'en faire une sorte d'hub inspiré d'un OS pour mieux me connaître (un poil mégalo sur les bords). 
        ...
        <p>Bon même si j'aime beaucoup la programmation qui me permet d'exprimer ma créativité et mon envie de créer des projets 
        ...
        <br/><br/>
        <p>Je prévois de développer quelques jeux, avec Unreal Engine. Bon j'apprends, mais ne vous inquiétez pas je suis un
        ...
        <p>Mais assez de blabla, je vous propose de quitter cette page et de cliquer sur les autres boutons, découvrir ce site et en apprendre
          plus sur moi, et si vous souhaitez discuter ou me poser des questions, n'hésitez pas à me contacter ! 
        </p>
        <br/><br/>
        <p>Merci de votre visite et à bientôt je l'espère !</p>
        <br/><br/>
        <p className="text-center">Le très beau et très fort développeur, Maxime Brunin (vous voyez qu'il se la raconte !)</p>
      </div>
