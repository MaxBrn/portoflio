  ...
  return (
    <div className="h-screen bg-cover bg-center bg-[url('/image/background.jpg')] overflow-hidden">
      ...
      <div className="h-full flex items-center justify-center p-2 md:p-4">
        ...
        <div className="bg-border rounded-lg shadow-xl border-4 border-border overflow-hidden transition-all duration-300 w-full h-full md:mb-0 mb-10 md:h-auto md:w-3/4 md:max-w-screen-md flex flex-col">
